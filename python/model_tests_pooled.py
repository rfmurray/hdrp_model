...
# model optimization
u_knot = [0, 1e-09, 9.821e-09, 0.002849, 0.007196, 0.01274, 0.02055, 0.031, 0.04502, 0.06415, 0.09018, 0.1253, 0.173, 0.2372, 0.326, 0.4425, 0.6043, 0.8214, 1.104, 1.495, 2.032, 2.756, 3.738, 5.083, 6.864, 9.347, 12.62, 17.18, 23.24, 31.48, 42.75, 57.66]
for t in tonemap:
...
for i, cubefile in enumerate(cubelist):
    fname = f'data2/data_L{int(testLambertian)}_T1{cubetag(cubefile)}.txt'
